...
class TestAudioPreprocessing:
    @pytest.fixture()
    def mono_wav(self, tmp_path: Path) -> Path:
    ...
    def test_preprocess_audio_returns_output_for_valid_input(self, mono_wav: Path):
        import shutil
    ...
    def test_transcribe_mono_with_preprocess_does_not_receive_none(self, mono_wav: Path, monkeypatch):
